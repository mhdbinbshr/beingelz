...
export function CustomCursor() {
  ...
  return (
    <>
      ...
      {/* Outer ring */}
      <motion.div
        className="fixed top-0 left-0 w-10 h-10 border border-white/50 rounded-full pointer-events-none z-[1000] mix-blend-difference flex flex-col items-center justify-center"
        animate={{
